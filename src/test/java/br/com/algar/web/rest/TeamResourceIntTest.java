...
public class TeamResourceIntTest {
    ...
    public void setup() {
        ...
        TeamResource teamResource = new TeamResource(teamRepository, userRepository, teamPokemonRepository, teamPokemonAbilityRepository);
     ...
     */
    public Team createEntity(EntityManager em) {
        Team team = new Team()
            .name(DEFAULT_NAME)
