...
public class TeamResource {
    ...
    public TeamResource(TeamRepository teamRepository,
                        ...
                        TeamPokemonAbilityRepository teamPokemonAbilityRepository) {
    ...
    public ResponseEntity<Team> createTeam(@RequestBody Team team) throws URISyntaxException {
        ...
        team.setUser(userRepository.findOneByLogin(SecurityUtils.getCurrentUserLogin()).get());
    ...
    public List<Team> getAllTeams() {
        ...
        return teamRepository.findByUserIsCurrentUser();
    }
